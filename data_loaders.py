...
def load_applestore_data(dataset_str, train_use_ratio=0, fold=0):
    ...
    idx_train, idx_val = read_folds(dataset_str = dataset_str, fold=fold)
...
def load_data(args, fold=0):
    ...
    if dataset_str in finance_datasets:
        ...
        return load_applestore_data(dataset_str, train_use_ratio, fold=fold)    
    '''
    return load_applestore_data(dataset_str, train_use_ratio, fold=fold)
