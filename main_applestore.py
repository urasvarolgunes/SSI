    ...
    def train_end_to_end(self, args):
        ...
        for trial in range(args.ntrials):
            ...
            model1 = GCN_S(nlayers=args.nlayers_adj, in_dim=nfeats, hidden_dim=args.hidden_adj, nclasses=nfeats,
                             ...
                             mlp_act=args.mlp_act, num_anchor=args.num_anchor)
            ...
            X[p:,(X.shape[1]-300):] = preds.cpu().numpy() #replace unknown embeddings with predicted embeddings
            print('Imptutation is finished. Performing KNN evaluation...')
            knn_dict = self.eval_knn(X, y, k_list = [5,10,20])
            print(knn_dict)
