...
class GCN_S(nn.Module):
    def __init__(self, nlayers, in_dim, hidden_dim, nclasses, dropout, dropout_adj, features, k, knn_metric, 
                 non_linearity, normalization, mlp_h, mlp_epochs, gen_mode, sparse, mlp_act, num_anchor, device = 'cuda'):
        super().__init__()
